              ...
              inputs: {
                SETUP: {
                  block: {
                    type: "variables_set",
                    fields: { VAR: { id: "br" } },
                    inputs: { VALUE: { block: { type: "math_number", fields: { NUM: 50 } } } },
                    next: {
                      block: {
                        type: "flipper_pwm_start",
                        fields: { PIN: "PA7" },
                        inputs: {
                          FREQ: { block: { type: "math_number", fields: { NUM: 1000 } } },
                          DUTY: { block: { type: "variables_get", fields: { VAR: { id: "br" } } } }
                        },
                        next: {
                          block: { type: "flipper_notify_sequence", fields: { SEQ: "sequence_success" } }
                        }
                      }
                    }
                  }
                ...
                DRAW: {
                  block: {
                    type: "flipper_canvas_clear",
                    next: {
                      block: {
                        type: "flipper_canvas_draw_text",
                        inputs: {
                          X: { block: { type: "math_number", fields: { NUM: 10 } } },
                          Y: { block: { type: "math_number", fields: { NUM: 14 } } },
                          TEXT: { block: { type: "text", fields: { TEXT: "LED Brightness" } } }
                        },
                        next: {
                          block: {
                            type: "flipper_canvas_draw_text",
                            inputs: {
                              X: { block: { type: "math_number", fields: { NUM: 10 } } },
                              Y: { block: { type: "math_number", fields: { NUM: 30 } } },
                              TEXT: { block: { type: "flipper_number_to_string", inputs: { NUMBER: { block: { type: "variables_get", fields: { VAR: { id: "br" } } } } } } }
                            },
                            next: {
                              block: {
                                type: "flipper_canvas_draw_text",
                                inputs: {
                                  X: { block: { type: "math_number", fields: { NUM: 45 } } },
                                  Y: { block: { type: "math_number", fields: { NUM: 30 } } },
                                  TEXT: { block: { type: "text", fields: { TEXT: "%" } } }
                                },
                                next: {
                                  block: {
                                    type: "flipper_canvas_draw_box",
                                    inputs: {
                                      X: { block: { type: "math_number", fields: { NUM: 10 } } },
                                      Y: { block: { type: "math_number", fields: { NUM: 44 } } },
                                      W: { block: { type: "variables_get", fields: { VAR: { id: "br" } } } },
                                      H: { block: { type: "math_number", fields: { NUM: 6 } } }
                                    },
                                    next: {
                                      block: {
                                        type: "flipper_widget_button",
                                        fields: { BTN: "GuiButtonTypeLeft" },
                                        inputs: { LABEL: { block: { type: "text", fields: { TEXT: "Less" } } } },
                                        next: {
                                          block: { type: "flipper_widget_button", fields: { BTN: "GuiButtonTypeRight" }, inputs: { LABEL: { block: { type: "text", fields: { TEXT: "More" } } } } }
                                        }
                                      }
                                    }
                                  }
                ...
                INPUT: {
                  block: {
                    type: "flipper_input_if_key_type",
                    fields: { TYPE: "InputTypeShort", KEY: "InputKeyLeft" },
                    inputs: {
                      DO: {
                        block: {
                          type: "math_change",
                          fields: { VAR: { id: "br" } },
                          inputs: { DELTA: { block: { type: "math_number", fields: { NUM: -5 } } } },
                          next: {
                            block: {
                              type: "controls_if",
                              inputs: {
                                IF0: { block: { type: "logic_compare", fields: { OP: "LT" }, inputs: { A: { block: { type: "variables_get", fields: { VAR: { id: "br" } } } }, B: { block: { type: "math_number", fields: { NUM: 0 } } } } } },
                                DO0: { block: { type: "variables_set", fields: { VAR: { id: "br" } }, inputs: { VALUE: { block: { type: "math_number", fields: { NUM: 0 } } } } } }
                              },
                              next: {
                                block: {
                                  type: "flipper_pwm_set",
                                  fields: { PIN: "PA7" },
                                  inputs: {
                                    FREQ: { block: { type: "math_number", fields: { NUM: 1000 } } },
                                    DUTY: { block: { type: "variables_get", fields: { VAR: { id: "br" } } } }
                                  },
                                  next: { block: { type: "flipper_request_redraw" } }
                                }
                              }
                            }
                          }
                    ...
                    next: {
                      block: {
                        type: "flipper_input_if_key_type",
                        fields: { TYPE: "InputTypeShort", KEY: "InputKeyRight" },
                        inputs: {
                          DO: {
                            block: {
                              type: "math_change",
                              ...
                              next: {
                                block: {
                                  type: "controls_if",
                                  inputs: {
                                    IF0: { block: { type: "logic_compare", fields: { OP: "GT" }, inputs: { A: { block: { type: "variables_get", fields: { VAR: { id: "br" } } } }, B: { block: { type: "math_number", fields: { NUM: 100 } } } } } },
                                    DO0: { block: { type: "variables_set", fields: { VAR: { id: "br" } }, inputs: { VALUE: { block: { type: "math_number", fields: { NUM: 100 } } } } } }
                                  },
                                  next: {
                                    block: {
                                      type: "flipper_pwm_set",
